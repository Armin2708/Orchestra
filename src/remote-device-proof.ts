...
/** Verify that every remote proof object already exists with its exact canonical definition. */
export function attestRemoteDeviceProofSchema(db: Database.Database): void {
