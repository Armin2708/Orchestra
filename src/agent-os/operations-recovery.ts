...
export const OPERATIONS_RECOVERY_SCHEMA_ID = '041-operations-recovery-foundation'
export const LEGACY_OPERATIONS_RECOVERY_SCHEMA_ID = '031-operations-recovery-foundation'
...
/** Attest every table/index owned by the operations-recovery migration without weakening it. */
...
/**
 * Install migration 041 only when every owned object is absent. Any partial or same-name schema
