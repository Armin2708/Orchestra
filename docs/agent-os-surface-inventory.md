...
|---|---:|---:|---:|---:|---:|
| SQLite application tables | 136 | 3 | 10 | 12 | 161 |
...
`src/agent-os/organization-assurance-migration.ts`. Exact ShipQueue receipts, attributed ContextUse
evidence, and the durable autoship outbox are defined in
