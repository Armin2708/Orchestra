...
Observed code: `fe2ef17f26bbab857ef735e611a3ad5243cc6be3`
...
The baseline inventory has 61 GET routes: 44 canonical, 3 compatibility, 9 legacy, and 5 infrastructure. They are not all equivalent. Health and the static shell are public bootstrap surfaces; process output, transcripts, conversations, assignment history, context, search/export, contract-template previews, live approval detail, settings, and system/provider information can reveal source, prompts, commands, paths, usage, or credentials.
