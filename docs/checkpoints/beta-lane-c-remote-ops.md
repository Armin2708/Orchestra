...
- Supply chain: root and web production audits report zero vulnerabilities. Accidental lockfile
  resolution drift was removed; no dependency manifest change remains.
